...
# Documentation here:
# https://github.com/Project-Flare/android_build_soong/commit/8328367c44085b948c003116c0ed74a047237a69

$(call add_soong_config_namespace,flareVarsPlugin)
$(foreach v,$(EXPORT_TO_SOONG),$(eval $(call add_soong_config_var,flareVarsPlugin,$(v))))
